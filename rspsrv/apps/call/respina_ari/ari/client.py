...
from rspsrv.apps.call.respina_ari.ari.model import *
from rspsrv.apps.call.respina_ari.swaggerpy import client as swagger_client
...
class Client(object):
    ...
    def __init__(self, base_url, http_client):
        ...
        self.swagger = swagger_client.SwaggerClient(
